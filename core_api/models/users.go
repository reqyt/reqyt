...
var (
	...
	userColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at", "name", "email"}
...
func (o *User) Wallets(mods ...qm.QueryMod) walletQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"rel_user_wallet\" on \"wallets\".\"id\" = \"rel_user_wallet\".\"wallet_id\""),
		qm.Where("\"rel_user_wallet\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadWallets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"wallets\".*, \"a\".\"user_id\""),
		qm.From("\"wallets\""),
		qm.InnerJoin("\"rel_user_wallet\" as \"a\" on \"wallets\".\"id\" = \"a\".\"wallet_id\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.CreatedAt, &one.UpdatedAt, &one.DeletedAt, &one.Key, &one.Credits, &localJoinCol)
		if err != nil {
			return errors.Wrap(err, "failed to scan eager loaded results for wallets")
		}
		if err = results.Err(); err != nil {
			return errors.Wrap(err, "failed to plebian-bind eager loaded slice wallets")
		}
...
// AddWalletsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Wallets.
// Sets related.R.Users appropriately.
// Uses the global database handle.
func (o *User) AddWalletsG(ctx context.Context, insert bool, related ...*Wallet) error {
	return o.AddWallets(ctx, boil.GetContextDB(), insert, related...)
}
...
func (o *User) AddWallets(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Wallet) error {
	...
	for _, rel := range related {
		query := "insert into \"rel_user_wallet\" (\"user_id\", \"wallet_id\") values (?, ?)"
...
// SetWalletsG removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Users's Wallets accordingly.
// Replaces o.R.Wallets with related.
// Sets related.R.Users's Wallets accordingly.
// Uses the global database handle.
func (o *User) SetWalletsG(ctx context.Context, insert bool, related ...*Wallet) error {
	return o.SetWallets(ctx, boil.GetContextDB(), insert, related...)
}
...
// Replaces o.R.Wallets with related.
// Sets related.R.Users's Wallets accordingly.
func (o *User) SetWallets(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Wallet) error {
	query := "delete from \"rel_user_wallet\" where \"user_id\" = ?"
	...
	removeWalletsFromUsersSlice(o, related)
	if o.R != nil {
		o.R.Wallets = nil
	}
...
// RemoveWalletsG relationships from objects passed in.
// Removes related items from R.Wallets (uses pointer comparison, removal does not keep order)
// Sets related.R.Users.
// Uses the global database handle.
func (o *User) RemoveWalletsG(ctx context.Context, related ...*Wallet) error {
	return o.RemoveWallets(ctx, boil.GetContextDB(), related...)
}

// RemoveWallets relationships from objects passed in.
// Removes related items from R.Wallets (uses pointer comparison, removal does not keep order)
// Sets related.R.Users.
func (o *User) RemoveWallets(ctx context.Context, exec boil.ContextExecutor, related ...*Wallet) error {
	var err error
	query := fmt.Sprintf(
		"delete from \"rel_user_wallet\" where \"user_id\" = ? and \"wallet_id\" in (%s)",
...
func removeWalletsFromUsersSlice(o *User, related []*Wallet) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
